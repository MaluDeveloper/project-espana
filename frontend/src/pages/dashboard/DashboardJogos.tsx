  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-muted-foreground text-base md:text-lg">{t.jogos.listing.subtitulo}</p>
      </motion.div>
        ...
        {GAME_CATEGORIES.map((cat, i) => {
          ...
          const card = (
            ...
            >
              ...
              <h2 className="font-display text-xl text-foreground mb-0.5">{tCat.title}</h2>
              <div className="text-xs font-semibold text-primary mb-2 italic">{cat.title}</div>
