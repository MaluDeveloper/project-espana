...
export const en = {
  ...
  hero: {
    ...
    brandTagline: "Spanish with AI",
    eyebrow: "Your Spanish, at your pace",
    titleLines: ["Learn", "Spanish"],
    titleEm: "with AI.",
    description: "A1–C2 courses, games, AI correction and DELE prep. A little every day, your way.",
    captionIdle: ["Drag to turn", "the world"],
    captionDragging: ["¡Vamos!", "Off to fluency."],
    captionPaused: ["Press Play", "to keep moving"],
    footerLeft: ["5 minutes a day", "Real fluency"],
    footerRight: ["Spanish,", "a little", "closer to you"],
    loading: "Your little world is taking shape…",
    fallback: "We couldn't load this little world.",
    retry: "Try again",
    planetLabel: "Rotate the planet",
    instructions:
      "Drag in any direction, or use the arrow keys, to rotate the 3D planet. Space pauses the planet and the character waves; press again to start. On touch screens, swipe outside the planet to scroll the page.",
    pause: "Pause",
    start: "Play",
    pauseLabel: "Pause and let the character wave",
    startLabel: "Start moving",
  },
