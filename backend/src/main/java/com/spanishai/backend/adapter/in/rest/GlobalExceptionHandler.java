package com.spanishai.backend.adapter.in.rest;

import com.spanishai.backend.adapter.in.rest.response.ApiError;
import com.spanishai.backend.domain.exception.InvalidRequestException;
import com.spanishai.backend.domain.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotReadable(HttpMessageNotReadableException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiError.of(HttpStatus.BAD_REQUEST.value(), "Corpo da requisicao invalido ou malformado"));
    }
