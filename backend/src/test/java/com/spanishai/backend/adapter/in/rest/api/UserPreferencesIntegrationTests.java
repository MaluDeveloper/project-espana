...
import com.spanishai.backend.adapter.out.persistence.user.ProfileJpaRepository;
import com.spanishai.backend.adapter.out.persistence.user.UserPreferencesJpaRepository;
...
class UserPreferencesIntegrationTests {
    ...
    @Autowired
    private UserPreferencesJpaRepository userPreferencesRepository;
